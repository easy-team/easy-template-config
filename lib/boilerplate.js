...
exports.boilerplateChoice = [
  ...
  {
    name: `Create ${chalk.green('NPM Package')} Boilerplate`,
...
exports.boilerplateDetailChoice = {
  'boilerplate-awesome': [
    {
      name: `Create ${chalk.green('NPM TypeScript Jest React')} Boilerplate`,
      value: '@easy-team/jest-typescript-react-example',
      pkgName: '@easy-team/jest-typescript-react-example',
      choices: ['name', 'description']
    },
    {
      name: `Create ${chalk.green('NPM TypeScript Jest Lib')} Boilerplate`,
      value: '@easy-team/jest-typescript-lib-example',
      pkgName: '@easy-team/jest-typescript-lib-example',
      choices: ['name', 'description']
    },
    {
  ...
  'boilerplate-vue': [
    ...
    {
      name: `Create ${chalk.green('Vue3 Single Page')} Application`,
      value: 'vue3-boilerplate',
      pkgName: 'easy-vue3-webpack5-boilerplate'
    },
    {
